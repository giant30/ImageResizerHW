    ...
    public class ImageProcess
    {
        ...
        public void ResizeImages(string sourcePath, string destPath, double scale)
        {
            ...
            foreach (var filePath in allFiles)
            {
                ...
                {
                    var result = await DoResizeAsync(filePath , destPath,scale);
                }));
        ...
        public int DoResize(string filePath, string destPath, double scale)
        {
        ...
        private async Task<int> DoResizeAsync(string filePath, string destPath, double scale)
        {
            return DoResize(filePath, destPath, scale); ;
        }
        ...
        /// <param name="destPath">產生圖片目的目錄路徑</param>
        /// <param name="scale">縮放比例</param>
        public void ResizeImagesOrigin(string sourcePath, string destPath, double scale)
        {
            var allFiles = FindImages(sourcePath);
            foreach (var filePath in allFiles)
            {
